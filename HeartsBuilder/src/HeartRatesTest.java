...
public class HeartRatesTest {
    public static void main(String[] args) {
        ...
        // Χρήση του Builder Pattern για τη δημιουργία αντικειμένου HeartRates
        HeartRates person = new HeartRates.Builder(firstName, lastName)
        ...
        System.out.println("Συχνότητα μέγιστου καρδιακού παλμού: " + person.calculateMaxHeartRate() + " παλμοί ανά λεπτό");
